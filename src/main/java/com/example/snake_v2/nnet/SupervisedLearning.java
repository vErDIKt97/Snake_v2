...
abstract public class SupervisedLearning extends IterativeLearning {
    ...
    protected final void learnPattern(DataSetRow trainingElement) {
        ...
        if (!batchMode) applyWeightChanges1(); // batch mode updates are done i doBatchWeightsUpdate
    }
     ...
     *
     * @see org.neuroph.core.learning.SupervisedLearning#doLearningEpoch(org.neuroph.core.data.DataSet)
     */
